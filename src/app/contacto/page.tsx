...
export default function ContactPage() {
  return (
    <main className="bg-hero-gradient w-full min-h-screen flex flex-col justify-center pt-35 md:pt-35 lg:pt-36 xl:pt-40 px-6 md:px-10 lg:px-31 xl:px-37 2xl:px-50 pb-30">
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-18 items-center">
        
        {/* Información, contexto y redes sociales */}
        <div className="lg:col-span-6 flex flex-col justify-center">
          <h1 className="text-[clamp(2.5rem,4vw,4rem)] font-bold text-black leading-[1.15] mb-6">
            ¿Hablamos de tu próximo proyecto?
          </h1>
          <p className="text-gray text-[clamp(1rem,1.5vw,1.25rem)] leading-relaxed mb-8 max-w-xl">
            ¿Buscas una diseñadora integral o desarrolladora fullstack para tu equipo o proyecto? Conversemos sobre cómo llevar tu producto digital al siguiente nivel.
          </p>
