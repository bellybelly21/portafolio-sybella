...
export default function ConstructionModal() {
  ...
  const handleClose = () => {
    ...
    // Disparamos un evento global para que el banner de cookies aparezca de inmediato
    window.dispatchEvent(new Event("constructionModalClosed"));
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 md:p-8 shadow-2xl border border-neutral-100 text-center relative">
        ...
        <div className="text-xs text-gray mb-6 font-medium">
